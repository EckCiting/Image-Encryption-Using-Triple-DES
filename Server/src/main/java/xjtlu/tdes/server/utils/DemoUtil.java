...
//            encryptedImageByte = encryptCipher.doFinal(image);
            ...
            encryptCipher2.init(Cipher.DECRYPT_MODE, key3);
...
//            final Cipher decryptCipher = Cipher.getInstance("DESede/ECB/PKCS5Padding");
//            decryptCipher.init(Cipher.DECRYPT_MODE, key);
//            decryptedImageByte = decryptCipher.doFinal(image);
